...
interface StatusFeature {
    interface ButtonsBuilder {
        suspend fun BehaviourContext.createButtonsForAdmin(suggestionId: SuggestionId): List<InlineKeyboardButton>
        suspend fun BehaviourContext.createButtonsForUser(suggestionId: SuggestionId): List<InlineKeyboardButton>
    }
